...
from administration.exceptions import (
...
class UserService:
    ...
    def update_user_role(admin_user, username, new_role, request=None):
        ...
        from administration.utils import _role_for_user, log_admin_action
    ...
    def generate_user_export_csv(admin_user, filters):
        ...
        for user in users.iterator(chunk_size=1000):
            ...
            yield f"{user.username},{user.email},{role},{status},{xp},{joined_at},{last_login}\n"
