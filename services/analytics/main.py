...
async def get_cluster_stats():
    ...
    try:
        async with httpx.AsyncClient() as client:
            ...
            return {
                "memory_usage_bytes": mem_response.json()["data"]["result"][0]["value"][1] if mem_response.status_code == 200 else 0,
                "cpu_usage_cores": cpu_response.json()["data"]["result"][0]["value"][1] if cpu_response.status_code == 200 else 0,
                "status": "healthy"
            }
